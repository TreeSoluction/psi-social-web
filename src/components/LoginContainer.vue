...
<template>
  ...
  >
    <div
      class="flex flex-col justify-center text-center p-6 sm:shadow-2xl sm:border-2 bg-white border-blue-500 md:max-w-96 rounded-md"
    >
      ...
      <form class="flex flex-col text-start gap-3" @submit="handleSubmit">
        ...
        <button class="p-2 bg-blue-500 rounded-lg mt-4 shadow-xl" type="submit">
          Entrar
        </button>
        <div class="text-center">
          Se voce ainda não tem uma conta
          <a class="text-blue-800"> clique aqui </a>
        </div>
        <div class="flex text-gray-500 italic">
          Não compartilhamos seus dados com terceiros. O processo de cadastro é
          totalmente anônimo.
        </div>
      </form>
    </div>
